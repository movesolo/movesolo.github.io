app.controller('PostController', ['$scope', '$http', '$rootScope', '$timeout', '$firebaseArray', 'metaTag', 'Auth', 'ngDialog',
    function ($scope, $http, $rootScope, $timeout, $firebaseArray, metaTag, Auth, ngDialog) {
